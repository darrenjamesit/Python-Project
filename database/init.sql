...
insert into products (name, price, stock, category_id, description)
    ...
    ('God of War: Ragnarok PS5', '319.99', '20', '2',
    'Kratos and Atreus embark on a mythical journey in search of answers and allies before Ragnarök. From Santa Monica Studio comes the sequel to the popular game God of War (2018). Kratos and Atreus must travel to each of the Nine Realms in search of answers as they prepare for the prophesied battle that will end the world. Together, Kratos and Atreus venture deep into the Nine Realms in search of answers, while the Asgardian forces prepare for war. Along the way, they will explore amazing mythical landscapes, make allies in all the lands and face terrifying enemies in the form of Nordic gods and monsters. As the threat of Ragnarök looms ever closer, Kratos and Atreus must choose between the safety of their family and that of their realms.'),
    ('Elden Ring PS5', '219.99', '14', '2',
    'In the Lands Between ruled by Queen Marika the Eternal, the Elden Ring, the source of the Erdtree, was shattered. Marikas descendants, all demigods, claimed the remnants of the Elden Ring known as the Great Runes, sparking a war: The Shattering. A war that meant the abandonment of Greater Will. And now the guidance of grace will be brought by the Tarnished who have been rejected by the grace of gold and exiled from the Lands Between. You dead who still live, your grace long lost, follow the path to the Lands Between to stand before the Elden Ring. And become an Elden Lord.'),
    ('Call of Duty: Modern Warfare 2 PS5', '259.99', '28', '2',
    'Welcome to the new era of Call of Duty! An innovative gameplay. New weapon handling. Advanced artificial intelligence. Modern Warfare II offers you a global campaign, addictive multiplayer battles and special ops based on the narrative. MODERN WARFARE II. Call of Duty: Modern Warfare II throws players into an unprecedented global conflict, in which the iconic operators of Task Force 141 return. CHARACTERISTICS. Infinity Ward will amaze fans with new gameplay mechanics. Fight alongside your friends and live an immersive experience thanks to the realistic sounds, lighting and graphics that form the basis of the most technically advanced Call of Duty in history. Modern Warfare II includes an advanced AI system, a new Gunsmith system with multiple weapon customization options, as well as novelties in both gameplay and graphics that will push the franchise to new heights.'),
...
insert into products (name, price, stock, category_id, description)
    ...
    ('Mickey Mouse Funko POP! Figurine.', '89.99', '18', '3',
    'Funko POP! Disney Mickey and Friends - Mickey Mouse no.1187'),
    ('Spider-Man Funko POP! Figurine.', '89.99', '11', '3',
    'Funko POP! Marvel Spider-Man - Spider-Man no.1160'),
    ('Baby Yoda Funko POP! Figurine.', '59.99', '46', '3',
    'Funko POP! Television The Mandalorian - The Child no.368'),
    ('Doctor Strange Funko POP! Figurine.', '59.99', '3', '3',
    'Funko POP! Marvel: Spider-Man - Doctor Strange no.1162'),
